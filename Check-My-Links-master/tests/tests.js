...
QUnit.test("test the startsWith function", assert => {
...
QUnit.test("test the contains function", assert => {
...
QUnit.test("test the rtrim function", assert => {
...
QUnit.test("test the removeClassFromElements function", assert => {
...
QUnit.test("test the getItem function: gets from localstorage", assert => {
    window.localStorage.getItem.withArgs('cache').returns("true");
    assert.equal(getItem("cache"),"true","asserting stub");
});

QUnit.test("test the getItem function: if not found", assert => {
...
QUnit.test("test the setItem function: parameters", assert => {
    setItem("cache","true");
...
QUnit.test("test the clearStrg function:", assert => {
    clearStrg();
...
QUnit.test("test the getOption function do not default", assert => {
...
QUnit.test("test the getOptions function Defaults", assert => {
...
QUnit.test("test the updateDisplay function global variables: passed", assert => {
...
QUnit.test("test the updateDisplay function global variables: warnings", assert => {
...
QUnit.test("test the updateDisplay function global variables: error", assert => {
...
QUnit.test("test the updateDisplay function global variables: dns error", assert => {
...
QUnit.test("test the updateDisplay function appended element: passed", assert => {
    updateDisplay(link,[],200);
...
QUnit.test("test the updateDisplay function appended element: warning", assert => {
    updateDisplay(link,["Warning: Empty Link"],200);
...
QUnit.test("test the updateDisplay function appended element: error", assert => {
    updateDisplay(link,[],404);
    assert.equal(link.outerHTML.contains("<span class=\"CMY_Response\">404</span>"), true, "Response element is appended when failed");
});

QUnit.test("test the updateDisplay function ReportBox display", assert => {
    updateDisplay(link,[],200);
